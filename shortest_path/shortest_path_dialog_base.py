...
class Ui_ShortestPathDialogBase(object):
    def setupUi(self, ShortestPathDialogBase):
        ...
        ShortestPathDialogBase.resize(1073, 646)
        ...
        self.gridLayout_2.addWidget(self.tabWidget, 0, 2, 10, 1)
        ...
        self.cb_path.addItem("")
        self.gridLayout_2.addWidget(self.cb_path, 5, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.line_maxdis, 7, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.line_export, 9, 0, 1, 1)
        self.bt_export = QtWidgets.QPushButton(ShortestPathDialogBase)
        self.bt_export.setObjectName("bt_export")
        self.gridLayout_2.addWidget(self.bt_export, 9, 1, 1, 1)
